...
var LogicLibrary = (function() { // 逻辑层
    return {
        DeviceInfoObj: function(params) {
            var info = {
                device_type: MethodLibrary.getDeviceType(), // 设备类型
                os: MethodLibrary.getOS(), // 操作系统
                os_version: MethodLibrary.getOSVersion(), // 操作系统版本
                user_agent: navigator.userAgent, // 包含以下属性中所有或一部分的字符串：appCodeName,appName,appVersion,language,platform
                app_version: navigator.appVersion, // 浏览器的版本号
